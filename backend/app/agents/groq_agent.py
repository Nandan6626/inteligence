...
def run_groq_agent(company_data: dict, missing_fields: list = None) -> str:
    # Use Groq Llama 3.3 for research
    ...
    try:
        ...
        search_context = search.invoke(f"{company_name} company profile, products, revenue, and competitors")
    ...
    try:
        ...
        print(f"Groq Agent failed with error: {e}. Attempting fallback to Gemini...")
        try:
